    ...
    <div class="w-full md:max-w-md md:shadow-xl md:rounded-2xl md:bg-white flex flex-col">
      ...
      <main class="flex-grow flex flex-col items-center text-center px-[1.618rem] sm:px-[2.618rem] pt-[1.618rem] pb-[4.236rem]">
        ...
        <div class="w-full max-w-sm">
          ...
          <h2 class="text-xl sm:text-2xl font-bold mb-[1.618rem]">Masuk Akun</h2>
          
          <div class="relative">
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              <svg class="w-6 h-5" viewBox="0 0 21 15"><g fill="none"><path fill="#FFF" d="M0 0h21v15H0z"/><path fill="#D52B1E" d="M0 0h21v8H0z"/></g></svg>
          ...
          <p class="mt-[1.618rem] text-sm text-gray-600">
            Belum Punya Akun? 
            <router-link to="/register" class="font-bold text-blue-600 hover:underline">Daftar Gratis</router-link>
          </p>
        </div>
      </main>
